...
#log_datei = open("python.log", "w")

#sys.stdout = log_datei

#workfolder = "C:\\TS Benachrichtiger\\System und Update Liste"
...
# Konfiguration
email_config = {
    "smtp_server": "203.0.113.19",
    "port": 25,
    "use_tls": False,
    "use_auth": False,
    "username": "smtptyp@kranzer.eu",
    "password": "hierdasPasswort",
    "sender_email": "smtptyp@kranzer.eu",
    "enable_email": True
}
